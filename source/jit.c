...
void initJIT(void) {
  ...
  HOOKFUNCTION(libKernelHandle, sceKernelJitCreateSharedMemory);
  HOOKFUNCTION(libKernelHandle, sceKernelJitCreateAliasOfSharedMemory);
  HOOKFUNCTION(libKernelHandle, sceKernelJitMapSharedMemory);
